...
import com.generationminusone.wordcount2015.AbstractListAdapter;
import com.generationminusone.wordcount2015.R;
...
public class BasicListAdapter extends AbstractListAdapter<BasicListAdapter.Entity, BasicListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(
                mInflater.inflate(R.layout.cards_layout, viewGroup, false)
        );
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        // RH: Define views within each row here; currently only one TextView present
